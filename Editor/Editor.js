...
function Editor(props) {
  ...
  const [values, setValues] = useState({
    ...
    github: activeInformation?.detail?.github || <a></a>,
  ...
  const basicInfoBody = (
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          label="Name"
          placeholder="Enter your full name eg. Aashu Mathew"
          value={values.name}
          onChange={(event) =>
  ...
  const referencesBody = (
    <div className={styles.detail}>
      <div className={styles.column}>
        <label>List your References</label>
        <InputControl
          placeholder="Line 1"
          value={values.points ? values.points[0] : ""}
          onChange={(event) => handlePointUpdate(event.target.value, 0)}
    ...
    switch (sections[activeSectionKey]) {
      ...
      case sections.education:
        ...
        case sections.AboutMe:
          return AboutMeBody;
      case sections.Technicalskills:
        return TechnicalskillsBody;
  ...
  useEffect(() => {
    ...
    setValues({
      ...
      Technicalskills: typeof activeInfo?.detail !== "object" ? activeInfo.detail : "",
    });
  }, [activeSectionKey]);
  ...
  useEffect(() => {
    ...
    setValues({
      ...
      linkedin: activeInfo.details[activeDetailIndex]?.link || "",
